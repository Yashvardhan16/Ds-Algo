class Solution {
    ...
    boolean function(char[][] board,int i,int j,int start,String word){
        ...
        visited[i][j] = true;
       if(function(board,i+1,j,start+1,word)||function(board,i-1,j,start+1,word)||function(board,i,j+1,start+1,word)||function(board,i,j-1,start+1,word)) return true;
      visited[i][j] = false;
        return false;
